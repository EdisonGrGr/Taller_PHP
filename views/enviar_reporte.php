...
<head>
    ...
    <title>Enviar Reporte de Empleados</title>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        <h4><i class="fas fa-envelope me-2"></i>Enviar Reporte de Empleados</h4>
                    </div>
                    <div class="card-body">
                        <?php if ($mensaje): ?>
                        ...
                        <form method="POST">
                            <div class="mb-3">
                                ...
                                <div class="form-text">Se enviará un PDF con el reporte completo de empleados</div>
                            </div>
                            ...
                            <div class="alert alert-info">
                                ...
                                <ul class="mb-0 mt-2">
                                    ...
                                    <li>Promedio salarial por departamento</li>
                                    <li>Departamento con mayor promedio</li>
                                    <li>Empleados que ganan sobre el promedio</li>
                                </ul>
                            </div>
